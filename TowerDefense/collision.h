/*
* File:   collision.h
* Authors: Nick Koirala (original version), ahnonay (SFML2 compatibility), S. Jacholke (extensions)
*
...
namespace Collision {
	...
	//point1 should be the center of the object, and radius, well the radius.
	//bool CircleTest(const sf::Vector2f& point1, const float& radius1, const sf::Sprite& Object2);
